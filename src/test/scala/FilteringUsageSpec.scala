...
class FilteringUsageSpec extends Specification with Tags {
  ...
  "Service API" should {
    ...
    val service100ver  = Service(name = "SERVICE1", url = "http://monservice:9000/servicev1.0.0", version = Some("1.0.0"))
    val service100vr5  = Service(name = "SERVICE1", url = "http://monservice:9000/servicev1.0.0", version = Some("1.0.0"), roles = Seq("ROLE5"))
    val service100vr1  = Service(name = "SERVICE1", url = "http://monservice:9000/servicev1.0.0", version = Some("1.0.0"), roles = Seq("ROLE1"))
    val service100vr2  = Service(name = "SERVICE1", url = "http://monservice:9000/servicev1.0.0", version = Some("1.0.0"), roles = Seq("ROLE1", "ROLE2"))
    val service100vr22 = Service(name = "SERVICE1", url = "http://monservice:9000/servicev1.0.0", version = Some("1.0.0"), roles = Seq("ROLE1", "ROLE3"))
    val service100vr3  = Service(name = "SERVICE1", url = "http://monservice:9000/servicev1.0.0", version = Some("1.0.0"), roles = Seq("ROLE1", "ROLE2", "ROLE3"))

    val service120     = Service(name = "SERVICE1", url = "http://monservice:9000/servicev1.2.0")
    val service120r4   = Service(name = "SERVICE1", url = "http://monservice:9000/servicev1.2.0", roles = Seq("ROLE4"))
    val service120ver  = Service(name = "SERVICE1", url = "http://monservice:9000/servicev1.2.0", version = Some("1.2.0"))
    val service120vr1  = Service(name = "SERVICE1", url = "http://monservice:9000/servicev1.2.0", version = Some("1.2.0"), roles = Seq("ROLE1"))
    val service120vr5  = Service(name = "SERVICE1", url = "http://monservice:9000/servicev1.2.0", version = Some("1.2.0"), roles = Seq("ROLE5"))
    val service120vr2  = Service(name = "SERVICE1", url = "http://monservice:9000/servicev1.2.0", version = Some("1.2.0"), roles = Seq("ROLE1", "ROLE2"))
    val service120vr22 = Service(name = "SERVICE1", url = "http://monservice:9000/servicev1.2.0", version = Some("1.2.0"), roles = Seq("ROLE1", "ROLE3"))
    val service120vr3  = Service(name = "SERVICE1", url = "http://monservice:9000/servicev1.2.0", version = Some("1.2.0"), roles = Seq("ROLE1", "ROLE2", "ROLE3"))

    val service200     = Service(name = "SERVICE1", url = "http://monservice:9000/servicev2.0.0")
    val service200r4   = Service(name = "SERVICE1", url = "http://monservice:9000/servicev2.0.0", roles = Seq("ROLE4"))
    val service200ver  = Service(name = "SERVICE1", url = "http://monservice:9000/servicev2.0.0", version = Some("2.0.0"))
    val service200vr1  = Service(name = "SERVICE1", url = "http://monservice:9000/servicev2.0.0", version = Some("2.0.0"), roles = Seq("ROLE1"))
    val service200vr5  = Service(name = "SERVICE1", url = "http://monservice:9000/servicev2.0.0", version = Some("2.0.0"), roles = Seq("ROLE5"))
    val service200vr2  = Service(name = "SERVICE1", url = "http://monservice:9000/servicev2.0.0", version = Some("2.0.0"), roles = Seq("ROLE1", "ROLE2"))
    val service200vr22 = Service(name = "SERVICE1", url = "http://monservice:9000/servicev2.0.0", version = Some("2.0.0"), roles = Seq("ROLE1", "ROLE3"))
    val service200vr3  = Service(name = "SERVICE1", url = "http://monservice:9000/servicev2.0.0", version = Some("2.0.0"), roles = Seq("ROLE1", "ROLE2", "ROLE3"))

    val service2200vr3  = Service(name = "SERVICE2", url = "http://monservice:9000/servicev2.0.0", version = Some("2.0.0"), roles = Seq("ROLE1", "ROLE2", "ROLE3"))
